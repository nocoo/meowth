...
- husky pre-commit / pre-push + 全套 6DQ 门通过

CI matrix（GitHub Actions darwin runner）仍是文档定义,代码尚未实施。具体进度看 [`docs/01-project-overview.md`](../01-project-overview.md) §10.1。
