...
const FG_CLASS: Record<AnsiColor, string> = {
  black: 'text-basalt-foreground',
  red: 'text-basalt-danger',
  green: 'text-basalt-heatmap-green-4',
  yellow: 'text-basalt-warning',
  blue: 'text-basalt-info',
  magenta:
    'text-[color-mix(in_srgb,hsl(var(--basalt-badge-purple)),hsl(var(--basalt-foreground))_55%)]',
  cyan: 'text-[color-mix(in_srgb,hsl(var(--basalt-badge-teal)),hsl(var(--basalt-foreground))_55%)]',
  white: 'text-basalt-foreground',
  brightBlack: 'text-basalt-muted-foreground',
  brightRed: 'text-basalt-danger',
  brightGreen: 'text-basalt-heatmap-green-4',
  brightYellow: 'text-basalt-warning',
  brightBlue: 'text-basalt-info',
  brightMagenta:
    'text-[color-mix(in_srgb,hsl(var(--basalt-badge-purple)),hsl(var(--basalt-foreground))_55%)]',
  brightCyan:
    'text-[color-mix(in_srgb,hsl(var(--basalt-badge-teal)),hsl(var(--basalt-foreground))_55%)]',
  brightWhite: 'text-basalt-foreground',
};

const BG_CLASS: Record<AnsiColor, string> = {
  black: 'bg-basalt-accent',
  red: 'bg-basalt-danger-tint',
  green: 'bg-basalt-heatmap-green-1/30',
  yellow: 'bg-basalt-warning-tint',
  blue: 'bg-basalt-info-tint',
  magenta: 'bg-basalt-badge-purple/15',
  cyan: 'bg-basalt-badge-teal/15',
  white: 'bg-basalt-bright',
  brightBlack: 'bg-basalt-accent',
  brightRed: 'bg-basalt-danger-tint',
  brightGreen: 'bg-basalt-heatmap-green-1/30',
  brightYellow: 'bg-basalt-warning-tint',
  brightBlue: 'bg-basalt-info-tint',
  brightMagenta: 'bg-basalt-badge-purple/15',
  brightCyan: 'bg-basalt-badge-teal/15',
  brightWhite: 'bg-basalt-bright',
};
